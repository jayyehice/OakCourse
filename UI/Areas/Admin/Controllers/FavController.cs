        ...
        public ActionResult UpdateFav(FavDTO model)
        {
            ...
            else
            {
                if (model.FavImage != null)
                {
                    ...
                    if (ext == ".jpg" || ext == ".jpeg" || ext == ".png" || ext == ".git")
                    {
                ...
                if (model.FavImage != null)
                {
                    if (System.IO.File.Exists(Server.MapPath("~/Areas/Admin/Content/AdsImage/" + returndto.Fav)))
                    {
                        System.IO.File.Delete(Server.MapPath("~/Areas/Admin/Content/AdsImage/" + returndto.Fav));
                    }
                }

                if (model.LogoImage != null)
                {
                    if (System.IO.File.Exists(Server.MapPath("~/Areas/Admin/Content/AdsImage/" + returndto.Logo)))
                    {
                        System.IO.File.Delete(Server.MapPath("~/Areas/Admin/Content/AdsImage/" + returndto.Logo));
                    }
                }
